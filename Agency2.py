...
class Agency:
    ...
    def terminateAgent(self,agentName):
        for entry in Register:
    ...
    def setupSat(self):
        ...
        port_ = self.getPortRandom()
        self.newUDP(sock_, UDPurl, port_, 600)
        strport = str(port_)
    ...
    def newUDP(self,sock_, url_, port_, timeout_):
        thread.start_new_thread(self.listenUDP, (sock_, url_, port_, timeout_))


    def listenUDP(self,sock_, url_, port_, timeout_):
    ...
    def handlePacket(self,sock_, pack_):
